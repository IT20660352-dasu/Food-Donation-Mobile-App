...
const DisplayObtainedDonation = (props) => {
  ...
  const onPressDeleteyes = () => {
    props.navigation.navigate('DisplayDeleteStatus');
  };
  return (
    <ImageBackground source={require("../../assets/images/donationreciver/CaptureDelteBlur.png")} resizeMode="cover" style={styles.image2}>
