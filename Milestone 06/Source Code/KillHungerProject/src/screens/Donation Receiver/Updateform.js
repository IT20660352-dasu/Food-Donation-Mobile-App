...
const Requestform = (props) => {
  ...
  const onPressUpdatedon = () => {
    props.navigation.navigate('SuccessUpdateReqAlert');
  };
  const onPressBack = () => {
        ...
        <View style={styles.container}>
          ...
          <View style={styles.formInputmenu}>
            <View style={{ justifyContent: 'center', alignItems: 'center', flexDirection: 'row' }}>
              ...
              <Text style={styles.create}>Update Form</Text>
          ...
          <Text style={{ fontSize:16, color:'#061356',marginLeft:1, fontWeight:'bold',marginTop:12}}>Name Of The Receiver</Text>     
            <TextInput
              ...
              value ="   Chandima sooriyaarachchi"
          ...
          <Text style={{ fontSize:16, color:'#061356',marginLeft:1, fontWeight:'bold',marginTop:1}}>Item Description </Text>     
            ...
            <TextInput
             ...
             value= "   I am a warden, so I want rice and curry for 20 people. those are children also below 15 years "
          ...
          <TouchableOpacity onPress={onPressUpdatedon} style={styles.defaultButton3}>
                <Text style={{ color: '#FFFFFF', fontSize: 18, }}> Update Donation </Text>
            </TouchableOpacity>
            </View>
