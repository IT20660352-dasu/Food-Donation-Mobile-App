...
import { FONTS, COLORS, SIZES, icons, constants } from "KillHungerProject/constants";
...
const DeliveryStatus = ({ navigation }) => {
    ...
    function renderInfo() {
        return (
           ...
           <Text style={{ textAlign: 'center', ...FONTS.h2, color: COLORS.black }}>13 Nov 2022 / 9:30AM</Text>
